...
public class LiveViewActivity extends Activity implements SurfaceTextureListener, OnClickListener {

    private static final int DATA_SEND_SECONDS = 3;
    private static final String TAG = LiveViewActivity.class.getName();
    ...
    private void initUI() {
        ...
        mDebugMsgOne = (TextView) findViewById(R.id.debugMsgOne);
        mDebugMsgTwo = (TextView) findViewById(R.id.debugMsgTwo);
    ...
    private void initPreviewer() {
        ...
        DJIBaseProduct product = DroneFlightMapperApplication.getProductInstance();
    ...
    private void captureAction() {
        ...
        final DJICamera camera = DroneFlightMapperApplication.getCameraInstance();
        if (camera != null) {
            ...
            mFlightController.setUpdateSystemStateCallback(new DJIFlightControllerDelegate.FlightControllerUpdateSystemStateCallback() {
                ...
                public void onResult(DJIFlightControllerCurrentState state) {
                    ...
                    LiveViewActivity.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            mDebugMsgOne.setText(Double.toString(droneLocation.getLatitude()));
                            mDebugMsgTwo.setText(Double.toString(droneLocation.getLongitude()));
                        }
                    });
                }
            });
    ...
    private void updateUi() {
        new Timer().scheduleAtFixedRate(new TimerTask() {
            @Override
            public void run() {
                mDatabase.child("/realtime-flights/").push().setValue(droneLocation);
            }
